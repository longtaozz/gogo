...
public class XEListViewHeader extends LinearLayout {
	...
	public XEListViewHeader(Context context) {
		super(context);
		initView(context);
	}
	 ...
	 * @param attrs
	 */
	public XEListViewHeader(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	}
	...
	private void initView(Context context) {
		...
		mContainer = (LinearLayout) LayoutInflater.from(context).inflate(
				R.layout.cs_xelistview_header, null);

...
import com.zt.capacity.jinan_yunshu.adapter.NotificationListAdapter;
import com.zt.capacity.jinan_yunshu.bean.PushRecord;
import com.zt.capacity.jinan_yunshu.request.push.IPushManager;
import com.zt.capacity.jinan_yunshu.request.push.PushManager;
 ...
 * 消息通知
 * @author lt
 * @time 2018/12/25 10:05
 *
 **/
@Route(path = "/jinan/yunshu/notification")
public class NotificationActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.jn_yunshu_activity_notification);

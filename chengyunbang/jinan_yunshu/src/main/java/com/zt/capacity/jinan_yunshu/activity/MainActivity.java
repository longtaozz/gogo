...
@Route(path = "/jinan/transit/main")
public class MainActivity extends BaseFragmentActivity implements View.OnClickListener {
    // Used to load the 'native-lib' library on application startup.
    public static MainActivity mainActivity = null;
    //济南主页链接
    String bHomeUrl = Web.htmlIP + Web.getHtmlProject() + JN_YunShu_Url.JINANZHENGFU + "?token=" + Web.getToken();
    ...
    public void onClick(View view) {
        ...
        if (i == R.id.bottom_1) {
            ...
            if (webViewFragment1 == null) {
                webViewFragment1 = WebViewFragment.newInstance(Web.htmlIP + Web.getHtmlProject() + JN_YunShu_Url.CAR + "?token=" + Web.getToken());
            }
...
//            ActivityJumpUtil.jumpActivity(this, LocationFActivity.class);
            ...
            if (webViewFragment2 == null) {
                webViewFragment2 = WebViewFragment.newInstance(Web.htmlIP + Web.getHtmlProject() + JN_YunShu_Url.COMPANY + "?token=" + Web.getToken());
            }
            ...
            if (webViewFragment3 == null) {
                webViewFragment3 = WebViewFragment.newInstance(Web.htmlIP + Web.getHtmlProject() + JN_YunShu_Url.CARD + "?token=" + Web.getToken() + "&sh=1");
            }
            ...
            if (webViewFragment4 == null) {
                webViewFragment4 = WebViewFragment.newInstance(Web.htmlIP + Web.getHtmlProject() + JN_YunShu_Url.DATACENTER + "?token=" + Web.getToken());
            }

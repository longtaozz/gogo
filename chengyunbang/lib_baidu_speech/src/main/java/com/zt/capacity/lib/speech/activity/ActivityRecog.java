...
import com.zt.capacity.lib.speech.baidu.AllRecogParams;
import com.zt.capacity.lib.speech.baidu.AutoCheck;
import com.zt.capacity.lib.speech.listener.MessageStatusRecogListener;
import com.zt.capacity.lib.speech.listener.StatusRecogListener;
import com.zt.capacity.lib.speech.utils.IStatus;
import com.zt.capacity.lib.speech.core.MyRecognizer;
import com.zt.capacity.lib.speech.utils.OfflineRecogParams;
...
public abstract class ActivityRecog extends BaseActivity implements IStatus {
     ...
     */
    protected AllRecogParams apiParams;
     ...
     */
    protected void initRecog(Handler discernHandler) {
        myReceiver = new MyReceiver();
        IntentFilter intentFilter = new IntentFilter("myreceiver");
        registerReceiver(myReceiver, intentFilter);
        StatusRecogListener listener = new MessageStatusRecogListener(discernHandler);
        if(myRecognizer != null){
            myRecognizer.release();
            myRecognizer = null;
        }
        myRecognizer = new MyRecognizer(this, listener);
        apiParams = new AllRecogParams(this);
        status = STATUS_NONE;
        if (enableOffline) {
...
//                        popupWindow.dismiss();
    ...
    protected abstract void clocePopuo();
    protected abstract void popuo();

    public ActivityRecog(Handler handler){

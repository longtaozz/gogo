...
public class WelcomeActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //安装权限申请
        JurisdictionUtil.REQUESTINSTALLPACKAGES(this);
...
//        permissionItems.add(new PermissionItem(Manifest.permission.REQUEST_INSTALL_PACKAGES, "安装", R.drawable.permission_ic_phone));
        permissionItems.add(new PermissionItem(android.Manifest.permission.WRITE_EXTERNAL_STORAGE, "写入", com.zt.capacity.common.R.drawable.permission_ic_storage));
        permissionItems.add(new PermissionItem(android.Manifest.permission.READ_EXTERNAL_STORAGE, "读取", com.zt.capacity.common.R.drawable.permission_ic_storage));
        permissionItems.add(new PermissionItem(android.Manifest.permission.CAMERA, "照相机", com.zt.capacity.common.R.drawable.permission_ic_camera));
...
//				jump();
    ...
    private void initData() {
        ...
        if (state == 0) {
            ...
            MyRoute.getInterface(WelcomeActivity.this).mainActivity();
            finish();
        } else {
            ActivityJumpUtil.jumpActivity(WelcomeActivity.this, LoginActivity.class);
            finish();
